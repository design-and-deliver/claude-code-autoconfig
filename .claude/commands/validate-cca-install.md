...
dev_only = ['deploy-to-npmjs.md', 'usage-report.md', 'analyze-session.md', 'migrate-new-session.md', 'session-close.js', 'statusline-cost.js', 'plan-progress.md', 'plan-progress.js', 'whats-happening.md', 'whats-happening.js', 'fleet.md', 'fleet.js', 'sync-worktrees.md', 'sync-worktrees.js', 'restore-after-reboot.md', 'restore-after-reboot.js', 'refactor.md', 'parallel-session-worktrees.md', 'worktree-gate.js', 'claim-registry.js', 'token-guard-liveness.js', 'cost-compare.md', 'gimme-one-liner.md', 'create-wip-report.md', 'abort-plan.md', 'eod-report.md']
